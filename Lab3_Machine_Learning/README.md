...
ใช้ random split 80/20 ใช้การแบ่งข้อมูลแบบ random split 80/20 โดยสุ่มค่าระหว่าง 0–1 
และเลือกค่าที่น้อยกว่า 0.8 เป็น training set ทำให้จำนวนข้อมูลไม่เท่ากับ 80/20 แบบพอดีแต่ใกล้เคียง
